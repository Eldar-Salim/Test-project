...
class ProductPage(BasePage):
    ...
    # Проверка на то, что стоимость корзины совпадает с ценой товара
    ...
    # Проверка на то, что yазвание товара в сообщении должно совпадать с тем товаром, который действительно добавлен
